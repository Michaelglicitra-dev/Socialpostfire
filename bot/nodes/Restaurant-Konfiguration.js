...
const cfg = {
  restaurant: {
    ...
    bild_guideline: {
      ...
      stile: {
        ...
        spotlight: 'STYLE Product Spotlight: a campaign picture built around one clear message and one call to action. A warm atmospheric food scene fills the frame and falls softly out of focus behind the message. The headline sits large and light in the upper area over the calmest part of the scene. A discreet rounded call-to-action block in the terracotta accent colour carries one short action line and sits directly under the headline block in the upper half, never in the lower third.',
  ...
  formate: {
    quadrat: { gen: '1024x1024', breite: 1024, hoehe: 1024, vertikal: false,
      hinweis: 'CANVAS: the picture is SQUARE (1:1). The text block keeps to the upper third and the dish fills the middle and lower area - there is less height than in a portrait picture, so keep the text to a headline and at most one short line under it. The lower part of the square is largely taken by the reserved logo and price areas, so keep the dish centred and the text high.' },
    hoch: { gen: '1024x1536', breite: 1024, hoehe: 1536, vertikal: false,
      hinweis: 'CANVAS: the picture is TALL (2:3 portrait). There is generous height, so the text block sits comfortably in the upper third and the dish fills the lower two thirds. The reserved areas sit along the bottom edge, so the dish should end above them.' },
